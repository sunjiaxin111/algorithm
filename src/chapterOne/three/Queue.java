...
public class Queue<Item> implements Iterable<Item> {
   ...
   /**
     ...
     * （破坏性地）连接两个同类对象
     */
    public void catenation(Queue<Item> addQueue){
        if(this == addQueue) throw new RuntimeException("不能连接本身！");
        if(addQueue == null || addQueue.isEmpty()) return;

        while(!addQueue.isEmpty()){
            enqueue(addQueue.dequeue());
        }
    }
